...
#     def raioInterno():
#         r_in = float(input('(em metros) Raio Interno: '))
#
#         if r_in <= 0:
...
#     def raioExterno():
#         r_ex = float(input('(em metros) Raio Externo: '))
#
#         if r_ex <= 0:
#             print("Informe um valor maior que 0")
#             raioExterno()
...
#     def comprimento():
#         L = float(input('(em metros) Comprimento: '))
#
#         if L <= 0:
#             print("Informe um valor maior que 0")
#             comprimento()
...
#         return L
#
#     dados = {'r_in': raioInterno(), 'r_ex': raioExterno(), 'L': comprimento()}
#     return dados
#
#
...
# grao = Grao()
# x = np.linspace(0, grao['r_in'] - grao[
#     'r_ex'])  # Distância em relação ao menor raio em direção ao maior raio, dividido em 50 segmentos [unidade: metro].
# A_b = 2 * np.pi * (grao['r_ex'] + x) * grao['L']  # Área do combustivel sendo queimada por segmento [unidade: metro**2].
...
###########################################
# def default_value(msg: str, value: float):
#     while True:
...
#
# print("""
# Programa de simulação de motor de foguete.
# Versão de terminal.
# """)
# temperatura = default_value("Temperatura:", 15.0)
# pressao = default_value("Pressão:", 30.0)
#
#
# def op1():
#     print("Opção 1")
...
# sair = lambda: exit()
#
# options = [("sair", sair), ("opção 1", op1), ("opção 2", op2)]
# while True:
...
# vetor = [1, 2, 3, 4]
# print(vetor)
# vetor = list(map(lambda x: x**2, vetor))
# print(vetor)
...
def simulator(temperatura=15, pressao=1):
    print("A temperatura é", temperatura)
    print("A pressao é", pressao)
